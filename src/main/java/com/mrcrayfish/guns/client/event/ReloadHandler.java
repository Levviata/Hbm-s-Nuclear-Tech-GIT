...
import static com.hbm.handler.ModChecker.isItemHeldFromCGM;

/**
 * Author: MrCrayfish
 */

// Basically the same as CGM's ReloadHandler but checking if the item is from it or not (this to avoid conflicts with other mods)
public class ReloadHandler
{
    ...
    public void onKeyPressed(InputEvent.KeyInputEvent event) {
        // Check if the held item is from the "CGM" mod
        if (isItemHeldFromCGM()) {
